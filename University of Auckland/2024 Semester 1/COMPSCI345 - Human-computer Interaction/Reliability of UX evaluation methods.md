...
- It means that, if you use the same formative evaluation method with several different user participants (for [[University of Auckland/2024 Semester 1/COMPSCI345 - Human-computer Interaction/Empirical|Empirical]] methods) or several different [[User eXperience (UX)]] inspectors (for analytic methods), you won't get the same list of [[User eXperience (UX)]] problems each time.
