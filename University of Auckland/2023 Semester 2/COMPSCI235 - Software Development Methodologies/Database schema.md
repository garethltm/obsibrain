...
### KEYS in [[University of Auckland/2023 Semester 2/INFOSYS222 - Database Systems/Database Management System (DBMS)|Database Management System (DBMS)]]
...
- Primary Key: A primary key is one of the candidate keys chosen by the [[University of Auckland/2023 Semester 2/COMPSCI235 - Software Development Methodologies/database|database]] designer to uniquely identify the entity set
- Related to: [[Keys]]