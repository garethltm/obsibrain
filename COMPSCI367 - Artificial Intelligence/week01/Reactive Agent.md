- [[COMPSCI367 - Artificial Intelligence/week01/Agent|Agent]] chose next [[action]] based on their current [[Percepts]] - using a set of rules which are simple to apply
