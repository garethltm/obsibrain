- [[agent|agent]] chose next [[action(s)]] based on their current [[COMPSCI367 - Artificial Intelligence/week01/Percepts]] - using a set of rules which are simple to apply
