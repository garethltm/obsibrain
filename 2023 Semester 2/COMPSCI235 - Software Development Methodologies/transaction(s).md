A [[transaction(s)]] is the execution of a sequence of 1 or more operations on a [[2023 Semester 2/COMPSCI235 - Software Development Methodologies/database|database]] to perform some higher-level function
