...
| **Convergence Accuracy**                 | More accurate since it computes the gradient using the entire [[training data]]                                                          | Less accurate since it computes the gradient using a                                        |
| **Computation & Memory Requirements**    | More Computation and Memory since it needs to process the entire [[training data]] in each iteration                                     |                                                                                             |
| **Optimization of Non-Convex Functions** | Can get stuck in local minima                                                                                                            |                                                                                             |
