...
| **Convergence Accuracy**                 | More accurate since it computes the gradient using the entire [[training data]]                                                          |                                                                                             |
| **Computation & Memory Requirements**    | More computation and Memory since it needs to process the entire [[trainning d]]                                                         |                                                                                             |
